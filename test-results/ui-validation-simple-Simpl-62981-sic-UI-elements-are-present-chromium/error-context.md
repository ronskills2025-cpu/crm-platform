...
- Name: ui-validation-simple.spec.ts >> Simple UI Validation >> Application loads and basic UI elements are present
- Location: e2e\ui-validation-simple.spec.ts:8:7
